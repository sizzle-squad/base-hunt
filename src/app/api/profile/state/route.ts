...
export async function GET(req: Request) {
    ...
    const {searchParams} = new URL(req.url);
     ...
     const data:QueryData[] = await prisma.$queryRaw`select  b.id,b.name,b.image_url,b.contract_address,b.token_id,b.cta_url,b.cta_text,b.type,w.to_address,w.transaction_hash,w.created_at,w.event_type from badge_configuration as b LEFT join webhook_data as w
