...
CREATE UNIQUE INDEX user_guild_score_claim_game_id_user_address_claim_id_idx ON public.user_guild_score_claim USING btree (game_id, user_address, claim_id);
