...
CREATE OR REPLACE FUNCTION "public"."getscorerankv2"("_game_id" bigint, "_user_address" "text") RETURNS TABLE("j" "json")
    LANGUAGE "plpgsql"
    AS $$
declare 
...
begin
 RETURN QUERY  select to_json(temp.*) from (select rank() over (order by current_score desc, updated_at asc) as rank, 
    user_address as user_address, current_score from score where game_id = _game_id ) as temp where temp.user_address = _user_address;
end; 
$$;

ALTER FUNCTION "public"."getscorerankv2"("_game_id" bigint, "_user_address" "text") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."guild_user_referral" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "game_id" bigint NOT NULL,
    "guild_id" "text" NOT NULL,
    "referrer_user_address" "text" NOT NULL,
    "join_user_address" "text" NOT NULL
);

ALTER TABLE "public"."guild_user_referral" OWNER TO "postgres";

ALTER TABLE "public"."guild_user_referral" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."guild_user_referral_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."user_address_unique_challenge_status" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    ...
    "challenge_status" "public"."challenge_status" NOT NULL,
    "content_data" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "challenge_uid" bigint NOT NULL
);

ALTER TABLE "public"."user_address_unique_challenge_status" OWNER TO "postgres";

ALTER TABLE "public"."user_address_unique_challenge_status" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."user_address_unique_challenge_status_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."guild_user_referral"
    ADD CONSTRAINT "guild_user_referral_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."user_address_unique_challenge_status"
    ADD CONSTRAINT "user_address_unique_challenge_status_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "guild_user_referral_game_id_guild_id_idx" ON "public"."guild_user_referral" USING "btree" ("game_id", "guild_id");

CREATE UNIQUE INDEX "guild_user_referral_game_id_guild_id_referrer_user_address__idx" ON "public"."guild_user_referral" USING "btree" ("game_id", "guild_id", "referrer_user_address", "join_user_address");

CREATE INDEX "guild_user_referral_game_id_referrer_user_address_guild_id_idx" ON "public"."guild_user_referral" USING "btree" ("game_id", "referrer_user_address", "guild_id");
...
CREATE UNIQUE INDEX "user_address_unique_challenge_status_game_id_challenge_uid_idx" ON "public"."user_address_unique_challenge_status" USING "btree" ("game_id", "challenge_uid");

CREATE INDEX "user_address_unique_challenge_status_game_id_user_address_idx" ON "public"."user_address_unique_challenge_status" USING "btree" ("game_id", "user_address");

CREATE INDEX "user_challenge_status_game_id_challenge_id_idx" ON "public"."user_challenge_status" USING "btree" ("game_id", "challenge_id");
...
ALTER TABLE "public"."guild_user_referral" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."user_address_unique_challenge_status" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."getscorerankv2"("_game_id" bigint, "_user_address" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."getscorerankv2"("_game_id" bigint, "_user_address" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."getscorerankv2"("_game_id" bigint, "_user_address" "text") TO "service_role";
...
GRANT ALL ON TABLE "public"."guild_user_referral" TO "anon";
GRANT ALL ON TABLE "public"."guild_user_referral" TO "authenticated";
GRANT ALL ON TABLE "public"."guild_user_referral" TO "service_role";

GRANT ALL ON SEQUENCE "public"."guild_user_referral_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."guild_user_referral_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."guild_user_referral_id_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."user_address_unique_challenge_status" TO "anon";
GRANT ALL ON TABLE "public"."user_address_unique_challenge_status" TO "authenticated";
GRANT ALL ON TABLE "public"."user_address_unique_challenge_status" TO "service_role";

GRANT ALL ON SEQUENCE "public"."user_address_unique_challenge_status_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."user_address_unique_challenge_status_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."user_address_unique_challenge_status_id_seq" TO "service_role";
